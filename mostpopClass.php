...
<h2> The most popular class by number of players characters. </h2>
<?php
$query = "select class.cname, count(class.cname) as numplayers from class join `character` on (class_idclass = idclass)
	group by cname
DESC LIMIT 1"
?>
